...
public class BSTVisualizer {
	...
	private final static int EMPTY_TREE_WIDTH = 0;
	// Diameter of nodes
	...
	public BSTVisualizer(String title, int width, int height) {
		canvas = new DrawingArea(title, width, height, Color.DARK_GRAY);
	}
	...
	private void drawTree(VNode vnode, int level, int offset) {
		...
		canvas.fillCircle(Color.MAGENTA, xPos, yPos, DIAMETER);
